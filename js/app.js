(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-program")) new core(".slider-program", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.2,
        ...
        if (document.querySelector(".slider-decision")) new core(".slider-decision", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.2,
        ...
        if (document.querySelector(".slider-comments")) new core(".slider-comments", {
            ...
            centeredSlides: true,
            pagination: {
                el: ".controls-slider-comments__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".comments-arrows .slider-arrow_prev",
                nextEl: ".comments-arrows .slider-arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.3,
